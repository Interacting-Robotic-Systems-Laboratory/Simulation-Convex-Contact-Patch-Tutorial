...
syms x y z real;
gcn = z;
%% contact constraints for cylinder

syms radius heg real; % dimension of the cylinder
 
syms l1 l2 l3 l4 real; % lagrangue multiplier
L = [l1;l2;l3;l4];
...
DST(1:3,1)=(a2-a1)+l4*(grad_a2);
DST(4:6,1)=grad_a2+sum_grad_a1;
DST(7:9,1) = -subs(Fcn,{x,y,z},{a1_x,a1_y,a1_z});
DST(10,1) = -subs(gcn,{x,y,z},{a2_x,a2_y,a2_z});  
DST(11,1) = subs(gcn,{x,y,z},{a1_x,a1_y,a1_z});

DST = simplify(DST);
fcn = [DYM;P_friction(1:3);DST(1:6);P_friction(4);DST(7:11)];
fcn = simplify(fcn);
...
Z(1,16) = sig;
Z(1,17:20) = [l1 l2 l3 l4];
Z(1,21) = p_n;

U(1,1:21) = Z;
U(1,22:25) = [q0 q1 q2 q3];

T(1,1:21) = Z;
T(1,22:30) = [R11 R12 R13 R21 R22 R23 R31 R32 R33];
T(1,31:39) = [I11 I12 I13 I21 I22 I23 I31 I32 I33];
T(1,40:42) = [q_x q_y q_z];
J1 = jacobian(fcn',T);
